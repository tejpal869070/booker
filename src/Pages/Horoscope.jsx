  ...
  return (
    <div>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8   pb-16 text-center  ">
        <div class="mx-auto flex justify-center items-center -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        ...
        <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          ...
          <span class="inline-block">{" "}_App Store</span>
        </h1>
        ...
        <div class="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
          <a
            class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-[#800000] text-white     active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 animate-fade-in-left"
            href="#"
          >
            <svg
              stroke="currentColor"
            ...
            <span class="ml-3">Get Personal HOroscope</span>
          </a>
          <div
          ...
          >
            <button
              class="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-[#800000] text-slate-700 hover:text-slate-900   active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300 animate-fade-in-right"
            ...
            >
              ...
              <span class="ml-3">Connect On Google Meet</span>
            </button>
          </div>
        </div>
      </div>
